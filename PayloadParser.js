function parseUplink(device, payload) {
    ...
    if (decodedMessage.bleDataList != null && Array.isArray(decodedMessage.bleDataList)) {
        for (var i = 0; i < decodedMessage.bleDataList.length; i++) {
            ...
            if (ble && ble.mac === "fd970b7e51f0" && ble.temp != null) {
            ...
            if (ble && ble.mac === "fd970b7e51f0" && ble.humidity != null) {
            ...
            if (ble && ble.mac === "fd970b7e51f0" && ble.lightIntensity != null) {
            ...
            if (ble && ble.mac === "fd970b7e51f0" && ble.batteryPercent != null) {
            ...
            if (ble && ble.mac === "fd970b7e51f0" && ble.rssi != null) {
            ...
            if (ble && ble.mac === "d946550f532e" && ble.temp != null) {
            ...
            if (ble && ble.mac === "d946550f532e" && ble.humidity != null) {
            ...
            if (ble && ble.mac === "d946550f532e" && ble.lightIntensity != null) {
            ...
            if (ble && ble.mac === "d946550f532e" && ble.batteryPercent != null) {
            ...
            if (ble && ble.mac === "d946550f532e" && ble.rssi != null) {
